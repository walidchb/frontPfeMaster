...
const AddTaskForm = ({ parentProject, handleCachAddTaskForm, reloadpage, reload }) => {
      ...
      >
        <div className="w-full">
          ...
          <p className="mb-4 text-red-500">
            {formik.errors.taskName && formik.touched.taskName && formik.errors.taskName}
          </p>
        </div>
        ...
        <div className="w-full">
          ...
          <p className="mb-4 text-red-500">
            {formik.errors.assignedTo && formik.touched.assignedTo && formik.errors.assignedTo}
          </p>
        </div>
